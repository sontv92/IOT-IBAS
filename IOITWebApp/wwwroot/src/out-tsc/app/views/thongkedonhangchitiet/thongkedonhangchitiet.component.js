...
var ThongKeDonHangChiTietComponent = /** @class */ (function () {
    function ThongKeDonHangChiTietComponent(http, modalDialogService, viewRef, toastr, commonService, datepipe, SpinnerService, router) {
        this.http = http;
    ...
    ThongKeDonHangChiTietComponent.prototype.ngOnInit = function () {
        this.ckeConfig = {
    ...
    ThongKeDonHangChiTietComponent.prototype.ResetCurrentRouter = function () {
    ...
    ThongKeDonHangChiTietComponent.prototype.changeFn = function (val) {
        this.disable = false;
        this.GetlistKH(val);
    ...
    ThongKeDonHangChiTietComponent.prototype.TaoTable = function () {
        this.tablesilde = [];
        this.GetListVatLieu();
    };
    // Get danh sách slide
    ThongKeDonHangChiTietComponent.prototype.GetListSlide = function () {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.ExportExcel = function () {
        var _this = this;
        if (this.role == 1) {
        ...
        //  debugger;
        fetch('/api/thongkedonhangchitiet/GetReportChiTiet?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&order_by=' + this.paging.order_by + '&tungay=' + _tungay + '&denngay=' + _denngay + '&TENHANGMUC=' + this.q.TENHANGMUC + '&CHEDO=' + this.q.value + '&TENKHACHHANG=' + this.q.TENKHACHHANG + '&CHEDO=' + this.q.value + '&BIENSO=' + this.q.BIENSO + '&TENMACBETONG=' + this.q.TENMACBETONG + '&TENNV=' + this.q.TENNV + '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid + '&query=' + this.paging.query + '&status=' + this.q.status + '&ckbKhachHang=' + this.q.ckbKhachHang + '&ckbXeTron=' + this.q.ckbXeTron + '&ckbMacBeTong=' + this.q.ckbMacBeTong, {
            method: 'GET',
            headers: new Headers({
                'Authorization': 'bearer ' + localStorage.getItem("access_token")
            }),
    ...
    ThongKeDonHangChiTietComponent.prototype.DownloadFile = function (data, filename, mime) {
    ...
    ThongKeDonHangChiTietComponent.prototype.GetlistKH = function (val) {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetlistCD = function () {
        this.listCheDo = [
            { Name: 'All', value: '' },
    ...
    ThongKeDonHangChiTietComponent.prototype.GetlistHM = function (val) {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetlistNV = function (val) {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetlistBienSo = function (val) {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetlistTenMacBeTong = function (val) {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetListCompany = function () {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetListBranchSearchStart = function () {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetListBranchCTCon = function () {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetListBranchSearch = function () {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetListVatLieu = function () {
        var _this = this;
    ...
    ThongKeDonHangChiTietComponent.prototype.GetBranch = function () {
    ...
    //Chuyển trang
    ThongKeDonHangChiTietComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListSlide();
    };
    //Toast cảnh báo
    ThongKeDonHangChiTietComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    //Toast thành công
    ThongKeDonHangChiTietComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    //Toast thành công
    ThongKeDonHangChiTietComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    //
    ThongKeDonHangChiTietComponent.prototype.changeStatusckbKhachHang = function (event) {
        this.q.ckbKhachHang = event;
    };
    //
    ThongKeDonHangChiTietComponent.prototype.QueryChanged = function () {
        if (this.role == 1) {
            if (this.q.CompanyId == undefined || this.q.CompanyId == null) {
                this.toastr.warning('Vui lòng chọn công ty !', 'Cảnh báo');
                return;
    ...
    ThongKeDonHangChiTietComponent.prototype.SortTable = function (str) {
        var First = "";
        var Last = "";
    ...
    ThongKeDonHangChiTietComponent.prototype.GetClassSortTable = function (str) {
    ...
    ], ThongKeDonHangChiTietComponent.prototype, "SlideModal", void 0);
    __decorate([
        core_1.ViewChild('file'),
        __metadata("design:type", core_1.ElementRef)
    ], ThongKeDonHangChiTietComponent.prototype, "file", void 0);
    ThongKeDonHangChiTietComponent = __decorate([
        core_1.Component({
    ...
    return ThongKeDonHangChiTietComponent;
}());
exports.ThongKeDonHangChiTietComponent = ThongKeDonHangChiTietComponent;
//# sourceMappingURL=thongkedonhangchitiet.component.js.map