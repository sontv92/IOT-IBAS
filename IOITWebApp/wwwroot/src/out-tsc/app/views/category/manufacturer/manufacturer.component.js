...
var ManufacturerComponent = /** @class */ (function () {
    function ManufacturerComponent(http, modalDialogService, viewRef, toastr, common) {
        this.http = http;
        ...
        this.paging.query = "TypeOriginId=1";
    ...
    // get ds nhà sản xuất
    ManufacturerComponent.prototype.GetListManufacturer = function () {
        var _this = this;
    ...
    // get ds công ty
    ManufacturerComponent.prototype.GetListCompany = function () {
        var _this = this;
    ...
    //Chuyển trang
    ManufacturerComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListManufacturer();
    };
    //Thông báo
    ManufacturerComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    ManufacturerComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    ManufacturerComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    ManufacturerComponent.prototype.QueryChanged = function () {
        var query = 'TypeOriginId=1';
    ...
    //Mở modal
    ManufacturerComponent.prototype.OpenModalManuFacturer = function (item) {
        this.Item = new model_1.Manufacturer();
    ...
    ManufacturerComponent.prototype.ChangeTitle = function (key) {
        switch (key) {
            case 1:
    ...
    // cập nhật 
    ManufacturerComponent.prototype.SaveManuFacture = function () {
        var _this = this;
        if (this.Item.Code == undefined || this.Item.Code == '') {
            this.toastWarning("Chưa nhập Mã nhà sản xuất!");
            return;
        }
            ...
            this.toastWarning("Chưa nhập tên nhà sản xuất!");
            return;
        }
    ...
    //Popup xác nhận xóa
    ManufacturerComponent.prototype.ShowConfirmDelete = function (Id) {
        var _this = this;
    ...
    ManufacturerComponent.prototype.Delete = function (Id) {
        var _this = this;
    ...
    //
    ManufacturerComponent.prototype.upload = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
    ...
    ManufacturerComponent.prototype.RemoveImage = function () {
        this.Item.Logo = undefined;
        this.file.nativeElement.value = "";
        this.progress = undefined;
    };
    ManufacturerComponent.prototype.ShowHide = function (id, i) {
        var _this = this;
    ...
    ManufacturerComponent.prototype.SortTable = function (str) {
        var First = "";
        var Last = "";
    ...
    ManufacturerComponent.prototype.GetClassSortTable = function (str) {
    ...
    ], ManufacturerComponent.prototype, "ModalManuFacture", void 0);
    __decorate([
        core_1.ViewChild('file'),
        __metadata("design:type", core_1.ElementRef)
    ], ManufacturerComponent.prototype, "file", void 0);
