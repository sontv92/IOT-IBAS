...
var ThongKeDonHangTongHopComponent = /** @class */ (function () {
    function ThongKeDonHangTongHopComponent(http, modalDialogService, viewRef, toastr, commonService, datepipe, SpinnerService, router) {
        this.http = http;
    ...
    ThongKeDonHangTongHopComponent.prototype.ngOnInit = function () {
        this.ckeConfig = {
        ...
        //   this.paging.query += "AND ( [D].GIOBATDAU >= convert(datetime ,'" + this.q.tungay + " 00:00:00.000') AND [D].GIOXONG <= convert(datetime ,'" + this.q.denngay + " 23:59:59.999') )";
        // }
        //
    ...
    ThongKeDonHangTongHopComponent.prototype.ResetCurrentRouter = function () {
    ...
    ThongKeDonHangTongHopComponent.prototype.changeFn = function (val) {
        this.disable = false;
        this.GetlistKH(val);
    ...
    ThongKeDonHangTongHopComponent.prototype.TaoTable = function () {
        this.tablesilde = [];
        this.GetListVatLieu();
    };
    // Get danh sách slide
    ThongKeDonHangTongHopComponent.prototype.GetListSlide = function () {
        var _this = this;
        ...
        this.http.get('/api/thongkedonhangtonghop/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&order_by=' + this.paging.order_by + '&tungay=' + this.q.tungay + '&denngay=' + this.q.denngay + '&TENKHACHHANG=' + this.q.TENKHACHHANG + '&BIENSO=' + this.q.BIENSO + '&TENMACBETONG=' + this.q.TENMACBETONG + '&TENHANGMUC=' + this.q.TENHANGMUC + '&TENNV=' + this.q.TENNV + '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid + '&query=' + this.paging.query + '&status=' + this.q.status + '&ckbKhachHang=' + this.q.ckbKhachHang + '&ckbXeTron=' + this.q.ckbXeTron + '&ckbMacBeTong=' + this.q.ckbMacBeTong, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.listDonHangChiTiet = res["data"];
                _this.paging.item_count = res["metadata"];
                _this.list_items = res["data"];
                _this.keys = Object.keys(_this.list_items[0]); // Get the column names
                _this.tableMockData = [
                    {
                        "header": "TH 1",
                        "rows": [
                ...
                console.log(_this.tableMockData);
    ...
    ThongKeDonHangTongHopComponent.prototype.ExportExcel = function () {
        var _this = this;
        if (this.role == 1) {
        ...
        fetch('/api/thongkedonhangtonghop/GetReportTongHop?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&order_by=' + this.paging.order_by + '&tungay=' + _tungay + '&denngay=' + _denngay + '&TENKHACHHANG=' + this.q.TENKHACHHANG + '&CHEDO=' + this.q.value + '&BIENSO=' + this.q.BIENSO + '&TENMACBETONG=' + this.q.TENMACBETONG + '&TENNV=' + this.q.TENNV + '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid + '&query=' + this.paging.query + '&status=' + this.q.status + '&ckbKhachHang=' + this.q.ckbKhachHang + '&ckbXeTron=' + this.q.ckbXeTron + '&ckbMacBeTong=' + this.q.ckbMacBeTong, {
            ...
            _this.DownloadFile(blob, _this.commonService.ConvertUrl(tenchinhanh.Name) + "_thong_ke_tong_hop_don_hang_" + date + ".pdf", 'application/pdf');
            //   this.DownloadFile(blob,   "_thong_ke_dn_hang" + date + ".xlsx", 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
            _this.SpinnerService.hide();
        });
    };
    ThongKeDonHangTongHopComponent.prototype.DownloadFile = function (data, filename, mime) {
    ...
    ThongKeDonHangTongHopComponent.prototype.GetlistKH = function (val) {
        var _this = this;
        this.http.get('/api/thongkedonhangchitiet/GetKH/' + val, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    ThongKeDonHangTongHopComponent.prototype.GetlistCD = function () {
        this.listCheDo = [
            { Name: 'All', value: '' },
    ...
    ThongKeDonHangTongHopComponent.prototype.GetlistHM = function (val) {
        var _this = this;
        this.http.get('/api/thongkedonhangchitiet/GetHangMuc/' + val, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.listHangMuc = res["data"];
            }
        }, function (err) {
            console.log("Error: connect to API");
        });
    ...
    ThongKeDonHangTongHopComponent.prototype.GetlistNV = function (val) {
        var _this = this;
        this.http.get('/api/thongkedonhangchitiet/GetNV/' + val, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    ThongKeDonHangTongHopComponent.prototype.GetlistBienSo = function (val) {
        var _this = this;
        this.http.get('/api/thongkedonhangchitiet/GetBienSo/' + val, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    ThongKeDonHangTongHopComponent.prototype.GetlistTenMacBeTong = function (val) {
        var _this = this;
        this.http.get('/api/thongkedonhangchitiet/GetTenMacBeTong/' + val, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    ThongKeDonHangTongHopComponent.prototype.GetListCompany = function () {
        var _this = this;
    ...
    ThongKeDonHangTongHopComponent.prototype.GetListBranchSearchStart = function () {
        var _this = this;
    ...
    ThongKeDonHangTongHopComponent.prototype.GetListBranchCTCon = function () {
        var _this = this;
    ...
    ThongKeDonHangTongHopComponent.prototype.GetListBranchSearch = function () {
        var _this = this;
    ...
    ThongKeDonHangTongHopComponent.prototype.GetListVatLieu = function () {
        var _this = this;
        this.http.get('/api/thongkedonhangchitiet/GetVatLieu?companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
    ...
    ThongKeDonHangTongHopComponent.prototype.GetBranch = function () {
    ...
    //Chuyển trang
    ThongKeDonHangTongHopComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListSlide();
    };
    //Toast cảnh báo
    ThongKeDonHangTongHopComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    //Toast thành công
    ThongKeDonHangTongHopComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    //Toast thành công
    ThongKeDonHangTongHopComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    //
    ThongKeDonHangTongHopComponent.prototype.changeStatusckbKhachHang = function (event) {
        this.q.ckbKhachHang = event;
    };
    //
    ThongKeDonHangTongHopComponent.prototype.QueryChanged = function () {
        if (this.role == 1) {
            if (this.q.CompanyId == undefined || this.q.CompanyId == null) {
                this.toastr.warning('Vui lòng chọn công ty !', 'Cảnh báo');
                return;
    ...
    ThongKeDonHangTongHopComponent.prototype.SortTable = function (str) {
        var First = "";
        var Last = "";
    ...
    ThongKeDonHangTongHopComponent.prototype.GetClassSortTable = function (str) {
    ...
    ], ThongKeDonHangTongHopComponent.prototype, "SlideModal", void 0);
    __decorate([
        core_1.ViewChild('file'),
        __metadata("design:type", core_1.ElementRef)
    ], ThongKeDonHangTongHopComponent.prototype, "file", void 0);
    ThongKeDonHangTongHopComponent = __decorate([
        core_1.Component({
            selector: 'app-thongkedonhangtonghop',
            templateUrl: './thongkedonhangtonghop.component.html',
    ...
    return ThongKeDonHangTongHopComponent;
}());
exports.ThongKeDonHangTongHopComponent = ThongKeDonHangTongHopComponent;
//# sourceMappingURL=thongkedonhangtonghop.component.js.map