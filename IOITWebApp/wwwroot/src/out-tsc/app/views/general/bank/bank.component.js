...
var BankComponent = /** @class */ (function () {
    function BankComponent(http, sanitizer) {
        this.http = http;
    ...
    //GET
    BankComponent.prototype.GetPMQLXe = function () {
        var _this = this;
        this.http.get('/api/Bank/GetByPage?userid=' + this.userid, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                ...
                _this.PMQLXe = _this.listBranch[0]["PMQLXe"];
                if (_this.PMQLXe != '' && _this.PMQLXe != undefined) {
                    _this.urlSafe = _this.sanitizer.bypassSecurityTrustResourceUrl(_this.PMQLXe);
                    _this.TargetBlank();
                }
            }
        }, function (err) {
    ...
    BankComponent.prototype.GetListCompany = function () {
        var _this = this;
    ...
    BankComponent.prototype.GetListBranchSearch = function () {
        var _this = this;
    ...
    BankComponent.prototype.CompanyChanged = function () {
        this.GetListBranchSearch();
    };
    ...
    BankComponent.prototype.TargetBlank = function () {
        //alert(this.urlSafe);
