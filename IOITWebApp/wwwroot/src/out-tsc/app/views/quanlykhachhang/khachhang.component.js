...
var $ = require("jquery");
var KhachHangComponent = /** @class */ (function () {
    function KhachHangComponent(http, modalDialogService, viewRef, toastr, datePipe, common) {
        this.http = http;
        ...
        this.Item = new model_1.KhachHang();
    ...
    KhachHangComponent.prototype.ngOnInit = function () {
    ...
    KhachHangComponent.prototype.GetListKhachHang = function () {
        var _this = this;
        // if (this.role != 1) {
        //   this.paging.query += ' and CompanyId = ' + this.companyId;
        // }
        this.http.get('/api/khachhang/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&query=' + this.paging.query + '&order_by=' + this.paging.order_by + '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid, this.httpOptions).subscribe(function (res) {
    ...
    KhachHangComponent.prototype.GetListCompany = function () {
        var _this = this;
    ...
    KhachHangComponent.prototype.GetListBranch = function () {
        var _this = this;
    ...
    //Chuyển trang
    KhachHangComponent.prototype.PageChanged = function (event) {
        this.paging.page = event.page;
        this.GetListKhachHang();
    };
    //Thông báo
    KhachHangComponent.prototype.toastWarning = function (msg) {
        this.toastr.warning(msg, 'Cảnh báo');
    };
    KhachHangComponent.prototype.toastSuccess = function (msg) {
        this.toastr.success(msg, 'Hoàn thành');
    };
    KhachHangComponent.prototype.toastError = function (msg) {
        this.toastr.error(msg, 'Lỗi');
    };
    KhachHangComponent.prototype.CompanyChanged = function () {
        //this.companyselect = this.Item.CompanyId;
        this.GetListBranch();
    };
    //
    KhachHangComponent.prototype.QueryChanged = function () {
        if (this.role == 1) {
    ...
    //
    KhachHangComponent.prototype.QueryChangedCompany = function () {
        var query = '';
        // if (this.q.txtSearch != undefined && this.q.txtSearch != '') {
        //   if (query != '') {
        //     query += " and TENKHACHHANG LIKE  \'%"+ this.q.txtSearch +"%\'";
        //   }
        //   else {
        //     query += "  TENKHACHHANG LIKE  \'%"+ this.q.txtSearch +"%\'";
        //   }
        // }
        if (this.q.CompanyId != undefined) {
    ...
    //Mở modal thêm mới
    KhachHangComponent.prototype.OpenAddModal = function () {
        if (this.q.BranchId == undefined || this.q.BranchId == null) {
    ...
    KhachHangComponent.prototype.changeFn = function (val) {
        this.Item.BranchId = val;
    };
    //Thêm mới danh mục trang
    KhachHangComponent.prototype.AddUserFunc = function () {
        var _this = this;
        ...
        if (this.Item.TENKHACHHANG == undefined || this.Item.TENKHACHHANG == '') {
            this.toastWarning("Chưa nhập Tên khách hàng!");
            return;
        }
        else if (this.Item.TENKHACHHANG.replace(/ /g, '') == '') {
            this.toastWarning("Chưa nhập Tên khách hàng!");
            return;
        }
        else if (this.Item.TENKHACHHANG == undefined || this.Item.TENKHACHHANG == '') {
            this.toastWarning("Chưa nhập Tên khách hàng!");
            return;
        }
        else if (this.Item.TENKHACHHANG.replace(/ /g, '') == '') {
        ...
        if (this.Item.ID) {
            this.Item.BranchId = this.q.BranchId;
            this.http.put('/api/khachhang/' + this.Item.ID, this.Item, this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    _this.GetListKhachHang();
            ...
            // }
            this.Item.BranchId = this.q.BranchId;
            this.http.post('/api/khachhang', this.Item, this.httpOptions).subscribe(function (res) {
                if (res["meta"]["error_code"] == 200) {
                    _this.GetListKhachHang();
                    _this.userModal.hide();
    ...
    KhachHangComponent.prototype.OpenEditModal = function (item) {
    ...
    //Popup xác nhận xóa
    KhachHangComponent.prototype.ShowConfirmDelete = function (Id, BranchId) {
        var _this = this;
    ...
    KhachHangComponent.prototype.ShowConfirmReset = function (Id) {
        var _this = this;
        this.modalDialogService.openDialog(this.viewRef, {
            title: 'Xác nhận',
            childComponent: ngx_modal_dialog_1.SimpleModalComponent,
    ...
    KhachHangComponent.prototype.XoaKH = function (Id, BranchId) {
        var _this = this;
        var strID = Id + "_" + BranchId;
        this.http.delete('/api/khachhang/' + strID, this.httpOptions).subscribe(function (res) {
            if (res["meta"]["error_code"] == 200) {
                _this.GetListKhachHang();
                _this.viewRef.clear();
    ...
    KhachHangComponent.prototype.ResetUser = function (Id) {
        var _this = this;
    ...
    KhachHangComponent.prototype.upload = function (files) {
        var _this = this;
        if (files.length === 0)
            return;
    ...
    KhachHangComponent.prototype.GetListFunction = function (IsNew) {
        var _this = this;
    ...
    KhachHangComponent.prototype.changeAction = function (cs) {
        var _this = this;
    ...
    KhachHangComponent.prototype.changeFull = function (i) {
        if (i != undefined) {
    ...
    KhachHangComponent.prototype.changeCell = function () {
        this.changeAction(10);
        this.changeFull(undefined);
    };
    KhachHangComponent.prototype.SortTable = function (str) {
        var First = "";
        var Last = "";
    ...
    KhachHangComponent.prototype.GetClassSortTable = function (str) {
    ...
    ], KhachHangComponent.prototype, "userModal", void 0);
    __decorate([
        core_1.ViewChild('file'),
        __metadata("design:type", core_1.ElementRef)
    ], KhachHangComponent.prototype, "file", void 0);
    KhachHangComponent = __decorate([
        core_1.Component({
...
exports.KhachHangComponent = KhachHangComponent;
//# sourceMappingURL=khachhang.component.js.map