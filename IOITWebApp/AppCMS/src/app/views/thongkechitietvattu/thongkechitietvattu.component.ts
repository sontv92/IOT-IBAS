...
@Component({
  selector: 'app-thongkechitietvattu',
  templateUrl: './thongkechitietvattu.component.html',
...
export class ThongKeChiTietVatTuComponent implements OnInit {
  ...
  GetListSlide() {
    ...
    this.http.get('/api/thongkechitietvattu/GetByPage?page=' + this.paging.page
  ...
  ExportExcel() {
    ...
    //  debugger;
    fetch('/api/thongkechitietvattu/GetReportChiTiet?page=' + this.paging.page + '&page_size=' + this.paging.page_size
                                                                               + '&order_by=' + this.paging.order_by 
                                                                               + '&tungay=' + _tungay 
                                                                               + '&denngay=' + _denngay
                                                                               + '&timetungay=' + this.q.timetungay
