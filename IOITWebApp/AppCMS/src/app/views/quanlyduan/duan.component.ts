...
export class DuAnComponent implements OnInit {
  ...
  GetlistDuAn() {
    ...
    // }
    this.http.get('/api/duan/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&query=' + this.paging.query + '&order_by=' + this.paging.order_by+ '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid, this.httpOptions).subscribe(
      (res) => {
  ...
  AddUserFunc() {
    ...
    if (this.Item.ID) {
      this.Item.BranchId = this.q.BranchId;
      this.http.put('/api/duan/' + this.Item.ID, this.Item, this.httpOptions).subscribe(
        (res) => {
          if (res["meta"]["error_code"] == 200) {
            this.GetlistDuAn();
            this.userModal.hide();
      ...
      this.http.post('/api/duan', this.Item, this.httpOptions).subscribe(
        (res) => {
          if (res["meta"]["error_code"] == 200) {
            this.GetlistDuAn();
            this.userModal.hide();
  ...
  XoaKH(Id,BranchId) {
    ...
    this.http.delete('/api/duan/' + strID, this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
          this.GetlistDuAn();
          this.viewRef.clear();
