...
export class ThongKeDonHangTongHopComponent implements OnInit {
  ...
  GetListSlide() {
    ...
    this.http.get('/api/thongkedonhangtonghop/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size 
    ...
    + '&TENKHACHHANG=' + this.q.TENKHACHHANG + '&BIENSO=' + this.q.BIENSO + '&TENMACBETONG=' + this.q.TENMACBETONG +'&TENHANGMUC=' + this.q.TENHANGMUC + '&TENNV=' + this.q.TENNV + '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid + '&query=' + this.paging.query + '&status=' + this.q.status + '&ckbKhachHang=' + this.q.ckbKhachHang + '&ckbXeTron=' + this.q.ckbXeTron + '&ckbMacBeTong=' + this.q.ckbMacBeTong + '&CHEDO=' + this.q.value, this.httpOptions).subscribe(
      ...
      (err) => {
        this.toastr.error('Có lỗi xảy ra, vui lòng liên hệ người quản trị', 'Lỗi');
        this.SpinnerService.hide();
  ...
  //  debugger;
    ...
    + '&TENKHACHHANG=' + this.q.TENKHACHHANG + '&CHEDO=' + this.q.value +'&BIENSO=' + this.q.BIENSO + '&TENMACBETONG=' + this.q.TENMACBETONG + '&TENNV=' + this.q.TENNV + '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid + '&query=' + this.paging.query + '&status=' + this.q.status + '&ckbKhachHang=' + this.q.ckbKhachHang + '&ckbXeTron=' + this.q.ckbXeTron + '&ckbMacBeTong=' + this.q.ckbMacBeTong, {
     ...
     //   this.DownloadFile(blob, this.commonService.ConvertUrl(tenchinhanh.Name) + "_thong_ke_tong_hop_don_hang_" + date + ".pdf", 'application/pdf');
