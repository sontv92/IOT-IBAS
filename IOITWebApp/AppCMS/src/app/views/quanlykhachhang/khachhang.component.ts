...
import { User, KhachHang } from '../../data/Model';
...
export class KhachHangComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.BranchId2 = localStorage.getItem('BranchId');
    ...
    if (this.role == 1) {
      ...
      if (this.role != 1 && this.role != 3) {
        this.paging.Branchid = this.BranchId2;
      }
  ...
  GetListKhachHang() {
    ...
    // }
    this.http.get('/api/khachhang/GetByPage?page=' + this.paging.page + '&page_size=' + this.paging.page_size + '&query=' + this.paging.query + '&order_by=' + this.paging.order_by+ '&companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid, this.httpOptions).subscribe(
      (res) => {
  ...
  AddUserFunc() {
    ...
    if (this.Item.ID) {
      this.Item.BranchId = this.q.BranchId;
      this.http.put('/api/khachhang/' + this.Item.ID, this.Item, this.httpOptions).subscribe(
        (res) => {
          if (res["meta"]["error_code"] == 200) {
            this.GetListKhachHang();
            this.userModal.hide();
      ...
      // }
      this.Item.BranchId = this.q.BranchId;
      this.http.post('/api/khachhang', this.Item, this.httpOptions).subscribe(
        (res) => {
          if (res["meta"]["error_code"] == 200) {
            this.GetListKhachHang();
            this.userModal.hide();
  ...
  XoaKH(Id,BranchId) {
    ...
    this.http.delete('/api/khachhang/' + strID, this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
          this.GetListKhachHang();
          this.viewRef.clear();
