...
@Component({
  selector: 'app-thongkechitietvattutheoxetron',
  templateUrl: './thongkechitietvattutheoxetron.component.html',
...
export class ThongKeChiTietVatTuTheoXeTronComponent implements OnInit {
  ...
  GetListSlide() {
    ...
    this.http.get('/api/thongkechitietvattutheoxetron/GetByPage?page=' + this.paging.page
      ...
      this.httpOptions).subscribe(
        (res) => {
          if (res["meta"]["error_code"] == 200) {
            if (res["data"] != null) {
              this.listChiTietVatTu = res["data"];
              console.log('fsdfsdf',this.listChiTietVatTu);
              this.paging.item_count = res["metadata"];
              this.listColumnName = res["ColumnNames"];
              this.countListColumnName = this.listColumnName.filter(x=>x.IsActive).length;
              switch (this.q.GroupBy) {
                case "KH":
                  this.listChiTietVatTu.forEach(item => {
              ...
              console.log('hgghjhjghj',this.listChiTietVatTu);
  ...
  ExportExcel() {
    ...
    //  debugger;
    fetch('/api/thongkechitietvattutheoxetron/GetReportChiTiet?page=' + this.paging.page + '&page_size=' + this.paging.page_size
                                                                               + '&order_by=' + this.paging.order_by 
                                                                               + '&tungay=' + _tungay 
                                                                               + '&denngay=' + _denngay
                                                                               + '&timetungay=' + this.q.timetungay
      ...
      .then(function (response) {
        ...
        this.DownloadFile(blob, this.commonService.ConvertUrl(tenchinhanh.Name) + "_bao_cao_chi_tiet_vat_tu_" + date + ".xlsx", 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
  ...
  GetlistKH(val) {
    this.http.get('/api/thongkechitietvattutheoxetron/GetKH/' + val, this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
  ...
  GetlistTenMacBeTong(val) {
    this.http.get('/api/thongkechitietvattutheoxetron/GetTenMacBeTong/' + val, this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
  ...
  GetListVatLieu() {
    this.http.get('/api/thongkechitietvattutheoxetron/GetVatLieu?companyid=' + this.paging.CompanyId + '&Branchlist=' + this.paging.Branchid, this.httpOptions).subscribe(
      (res) => {
        if (res["meta"]["error_code"] == 200) {
