...
namespace IOITWebApp.Controllers.ApiCMS
{
    ...
    [ApiController]
    public class ThongKeDonHangChiTietController : ControllerBase
    {
        private static readonly ILog log = LogMaster.GetLogger("thongkedonhangchitiet", "thongkedonhangchitiet");
        private static string functionCode = "TKDHCT";
        private IHostingEnvironment _hostingEnvironment;
        public ThongKeDonHangChiTietController(IHostingEnvironment hostingEnvironment)
        {
